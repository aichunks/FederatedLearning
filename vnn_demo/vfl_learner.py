...
class VerticalFederatedLearningLearner(object):
    ...
    def fit(self, train_data, test_data, epochs=50, batch_size=-1, is_parallel=True, verbose=False,model_path="", is_debug=False):
        ...
        with tf.Session() as sess:
            ...
            for ep in range(epochs):
                ...
                for batch_idx in range(n_batches):
                    ...
                    if is_parallel:
                        if verbose: print("[INFO] fit using parallel scheme",self.federated_learning)
            ...
            self.federated_learning.saveModels(model_path)
            result_dict = dict()
