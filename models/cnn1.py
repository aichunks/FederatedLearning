...
class Layer(object):
    ...
    def load_weight(self, model_parameters):
        pass
...
class BatchNormalizationLayer(Layer):
    ...
    def load_weight(self, model_parameters):
        self.owner_model_id = model_parameters["owner_model_id"]
        self.layer_id = model_parameters["layer_id"]
        self.bn_layer.beta_initializer = tf.constant_initializer(model_parameters["bn_beta"])
        self.bn_layer.gamma_initializer = tf.constant_initializer(model_parameters["bn_gamma"])
        self.bn_layer.moving_mean_initializer = tf.constant_initializer(model_parameters["bn_moving_mean"])
        self.bn_layer.moving_variance_initializer = tf.constant_initializer(model_parameters["bn_moving_variance"])
...
class ConvolutionLayer(Layer):
    ...
    def load_weight(self, model_parameters):
        ...
        self.stride_size = model_parameters["stride_size"]
        self.filter_initializer = model_parameters["filter_weights"]
        self.filter_weights=model_parameters["filter_weights"]
...
def BuildCnnModels(learning_rate,proximal_lbda):
    ...
    simpleCNN_B.build(input_shape=(28, 14, 1), representation_dim=256, class_num=2, lr=learning_rate,
                      proximal_lbda=proximal_lbda)
    return simpleCNN_A,simpleCNN_B